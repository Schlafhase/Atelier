...
public readonly struct Vec4(double x, double y, double z, double w)
{
	...
	public static Vec4 operator +(Vec4 a, double b) => new(a.X + b, a.Y + b, a.Z + b, a.W + b);

	public static Vec4 operator +(double b, Vec4 a) => a + b; // Commutative addition
	...
	public static Vec4 operator -(double b, Vec4 a) => new(b - a.X, b - a.Y, b - a.Z, b - a.W);
	...
	public static Vec4 operator *(double b, Vec4 a) => a * b; // Commutative multiplication
	...
	public double DotProduct(Vec4 b) => X * b.X + Y * b.Y + Z * b.Z + W * b.W;

	public Vec4 Normalise() => this / Length;


	public static implicit operator Color(Vec4 vec) =>
		new Color((int)(MathV.Clamp01(vec.X) * 255),
