...
public static class MathV
{
	...
	public static Vec2 Clamp01(Vec2 value) => new(Clamp01(value.X), Clamp01(value.Y));
	...
	public static Vec3 Clamp01(Vec3 value) => new(Clamp01(value.X), Clamp01(value.Y), Clamp01(value.Z));
	...
	public static Vec4 Clamp01(Vec4 value) =>
		new(Clamp01(value.X), Clamp01(value.Y), Clamp01(value.Z), Clamp01(value.W));
	...
	/// </param>
	/// <returns>The interpolated value between <see cref="a" /> and <see cref="b" /></returns>
	public static Vec2 Lerp(Vec2 a, Vec2 b, double t) => new(Lerp(a.X, b.X, t), Lerp(a.Y, b.Y, t));
	...
	/// </param>
	/// <returns>The interpolated value between <see cref="a" /> and <see cref="b" /></returns>
	public static Vec3 Lerp(Vec3 a, Vec3 b, double t) => new(Lerp(a.X, b.X, t), Lerp(a.Y, b.Y, t), Lerp(a.Z, b.Z, t));
